...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ibroh.im — I build, learn, and share." },
      {
        name: "description",
        content:
      ...
      { property: "og:url", content: "https://ibroh.im" },
      { property: "og:image", content: "https://ibroh.im/og-default.svg" },
      { property: "og:site_name", content: "ibroh.im" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ibroh.im — I build, learn, and share." },
      {
        name: "twitter:description",
        content: "The personal website of Ibrohimbek: projects, writing, and experiments.",
      },
      { name: "twitter:image", content: "https://ibroh.im/og-default.svg" },
      { name: "robots", content: "index, follow" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "canonical", href: "https://ibroh.im" },
